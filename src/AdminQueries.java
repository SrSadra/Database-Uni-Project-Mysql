public class AdminQueries {
    ...
    public final static String CREATE_PROFILE_TABLE = "CREATE TABLE Profile (" +
        "Username varchar(30) NOT NULL,Id int PRIMARY KEY AUTO_INCREMENT,Intro varchar(100),Featured varchar(100),About nvarchar(250),Background_id int, Position nvarchar(50),Location nvarchar(50),Company nvarchar(50)," +
    ...
    public final static String CREATE_PROFILE_SKILLS_TABLE = "CREATE TABLE Profile_skills (" +
        "Skill_id int NOT NULL,Profile_id int NOT NULL,endorse_count int NOT NULL,CONSTRAINT PK_profile_skills PRIMARY KEY (Profile_id,Skill_id));" ;
    ...
    public final static String CREATE_NOTIF_TABLE = "CREATE TABLE notif (" +
        "id int NOT NULL PRIMARY KEY AUTO_INCREMENT,reason nvarchar(4000) NOT NULL,caused_by_id int NOT NULL,time date NOT NULL, cause_no int)" ; 
    // public final static String CREATE_PROF_NOTIF_TABLE = "CREATE TABLE profile_notif (" +
